            ...
            <Container className="introduction" fluid>
                <Row>
                    ...
                    <Col lg={6} md={12} sm={12} className="text-area-introduction">
                        ...
                        <p>My Name is Sachin Rajkumar Saini. I am From Bharuch, Gujarat. I Have Completed My Class 10 & 12 From Gujarat. Now, I am Doing My Graduation From Poornima College of Engineering.</p>
                        ...
                        <Button className="primary-btn-introduction shadow-none">Download CV</Button>
                    </Col>
                </Row>
            </Container>
        </Fragment>
